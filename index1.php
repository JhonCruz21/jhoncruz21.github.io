...
if (isset($_SESSION['usuario'])) {
    header("location:./PlanDeportivo.php");
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="styles/estiloSignLogin0.css">
    ...
    <main class="container main" id="seccion4">
        <div class="contenedor__todo">
            ...
            <div class="contenedor__login-register">
                <!--Login-->
                <form action="ingresoUSuario.php" method="POST" class="formulario__register">
                ...
                <!--Register-->
                <form action="registroUsuario.php" method="POST" class="formulario__login">
                    <h2>Regístrarse</h2>
